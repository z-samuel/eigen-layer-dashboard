            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    config = new swagger_1.DocumentBuilder()
                        .setTitle('EigenLayer Dashboard API')
                        .setDescription('API documentation for EigenLayer Dashboard')
                        .setVersion('1.0')
                        .addTag('dashboard')
                        .build();
                ...
                case 2:
                    ...
                    console.log("\uD83D\uDCDA API documentation available at http://localhost:".concat(port, "/api"));
                    return [2 /*return*/];
            }
        });
    });
