...
var AppController = function () {
    ...
    (function () {
        ...
        _getHello_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get API status' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'API is running' })];
        _getHealth_decorators = [(0, common_1.Get)('health'), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is healthy' })];
